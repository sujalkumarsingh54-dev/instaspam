# main.py  (ya app.py – jo bhi naam hai tera file ka)
...
app = Flask(__name__)
app.secret_key = "sujal_hawk_king_007_2025"

# ← YE APNA CHANGE KAR LE
...
def login():
    ...
    return '''
    <center style="margin-top:15%;font-family:Arial;background:linear-gradient(135deg,#667eea,#764ba2);height:100vh">
    <h1 style="color:white">HAWK SUJAL SPAMMER v9</h1>
    <form method="post">
...
def index():
    ...
    if request.method == 'POST':
        ...
        data.update({
            ...
            "delay": float(request.form['delay'] or 8),
            "cycle_count": int(request.form['cycle_count'] or 50),
            "cycle_break": int(request.form['cycle_break'] or 35),
